...
|---|---|---|---|
| relais-admin | relay-only | — | relay-admin-a, relay-admin-b, relay-admin-dc |
...
| relay-admin-a | relais-admin | centre-a | relay-admin-a.vpn.example.org:51820 | 10.10.12.0/24 | 10.40.10.0/24 | yes |
| relay-admin-b | relais-admin | centre-b | relay-admin-b.vpn.example.org:51820 | 10.10.22.0/24 | 10.40.20.0/24 | yes |
| relay-admin-dc | relais-admin | datacenter | relay-admin-dc.vpn.example.org:51820 | 10.10.40.0/24 | 10.40.40.0/24 | yes |
...
|---|---|---|
| admins | relais-admin, wdg-admins | vlan-admin-a, vlan-admin-b, vlan-admin-dc, vlan-metier |
